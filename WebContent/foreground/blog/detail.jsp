...
<div class="data_list">
    ...
    <div>
        ...
        <div class="blog_info">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:forEach items="${keyWorlds}" var="keyWorld">
                            <!-- 标签显示为超链接 点击查询跟类型的博客 -->
                            &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/blog/search.action?q=${keyWorld}">${keyWorld}</a>&nbsp;
                        </c:forEach>
                    </c:otherwise>
                </c:choose>
            </div>
            ...
            <div style="float:right">
                ...
                』&nbsp;&nbsp; 博客类别：
                <a href="${pageContext.request.contextPath}/index.action?typeId=${blog.blodType.id}">${blog.blodType.name}</a>
    ...
    <div style="line-height: 3;background-color:#F8F8FF;">
        <span style="color: #8b2323">作者：个人博客&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊重博主原创文章，转载请注明文章出于此处。</span>
    </div>
    <!-- 水平分割线 -->
                    ...
                    <c:forEach items="${commentList}" var="comment" varStatus="">
                        <c:choose>
                            ...
                            <c:when test="${status.index<10 }">
                                        <span>
											${status.index+1}楼&nbsp;&nbsp;&nbsp;&nbsp;${comment.uname}
										&nbsp;&nbsp;&nbsp;&nbsp;${comment.content }&nbsp;&nbsp;&nbsp;&nbsp;
										[
                            ...
                            <c:otherwise>
                                    <span>
											${status.index+1}楼&nbsp;&nbsp;&nbsp;&nbsp;${comment.userId }
										&nbsp;&nbsp;&nbsp;&nbsp;${comment.content }&nbsp;&nbsp;&nbsp;&nbsp;
										[
                                            <fmt:formatDate value="${comment.commentDate }" type="date" pattern="yyyy-MM-dd HH:mm"/>
                                        ]
