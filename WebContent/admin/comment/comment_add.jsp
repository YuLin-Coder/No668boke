...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/comment_add.action" method="post" id="addForm">
							...
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                    ...
                                    <c:forEach items="${bloggerList}" var="info">
                                        <option value="${info.id}">${info.nickname}</option>
                                    </c:forEach>
                                </select>
								</div>
							</div>
               ...
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <textarea rows="5" cols="80" id="content" name="content" class="form-control" tip="请输入评论内容"></textarea>
								</div>
							</div>
						</div>
					</div>
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <input id="cdate" name="cdate" size="35" class="form-control"   type="text" value=""  tip="请输入评论时间" />
								</div>
							</div>
						</div>
					</div>
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <input id="state" name="state" size="35" class="form-control"   type="text" value=""  tip="请输入评论状态" />
								</div>
							</div>
						</div>
					</div>
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <input id="blogid" name="blogid" size="35" class="form-control"   type="text" value=""  tip="请输入博客" />
								</div>
							</div>
						</div>
					</div>
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <input id="uname" name="uname" size="35" class="form-control"   type="text" value=""  tip="请输入评论人" />
								</div>
							</div>
						</div>
					</div>
