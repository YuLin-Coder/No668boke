	...
	<div class="page-content">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<%=path%>/user_upwd.action" method="post" id="addForm">
							...
							<div class="col-sm-8">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="uname" name="uname" readonly="readonly" size="35" class="form-control" type="text" value="${sessionScope.user.uname}" tip="请输入用户名" />
									</div>
								</div>
							</div>
						</div>
