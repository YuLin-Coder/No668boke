							...
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="uname" name="uname" size="35" value="${user.uname}"
						...
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="upwd" name="upwd" size="35" value="${user.upwd}"
											readonly="readonly" class="form-control" type="text" />
									</div>
								</div>
							</div>
						...
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="name" name="name" size="35" value="${user.name}"
											readonly="readonly" class="form-control" type="text" />
									</div>
								</div>
							</div>
						...
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="sex" name="sex" size="35" value="${user.sex}"
											readonly="readonly" class="form-control" type="text" />
									</div>
								</div>
							</div>
						...
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="tel" name="tel" size="35" value="${user.tel}"
											readonly="readonly" class="form-control" type="text" />
									</div>
								</div>
							</div>
						...
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="zzmm" name="zzmm" size="35" value="${user.zzmm}"
											readonly="readonly" class="form-control" type="text" />
									</div>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="xueyuan" name="xueyuan" size="35"
											value="${user.xueyuan}" readonly="readonly"
								...
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="zhuanye" name="zhuanye" size="35"
											value="${user.zhuanye}" readonly="readonly"
											class="form-control" type="text" />
									</div>
								</div>
							</div>
						...
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input size="35" value="${info.zt==0?'否':'是'}"
											readonly="readonly" class="form-control" type="text" />
									</div>
								</div>
							</div>
