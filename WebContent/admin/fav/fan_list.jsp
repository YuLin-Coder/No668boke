...
<html>
	...
	<body>
		<div class="page-content">
			<form action="<%=path%>/fan_list.action" class="form-inline"
				method="post">
				<div class="panel panel-default">
					...
					<pg:pager url="fan_list.action" items="${itemSize}"
										...
										<tr>
											...
											<td>
												...
												<a href="javascript:void();"
													...
													class="glyphicon glyphicon-trash"></span>移除粉丝</a>
...
function delInfo(id){
	 if(confirm("是否确认移除粉丝吗？")){
	 window.location.href = '<%=path%>/fan_delete.action?id=' + id;
    }
}
</script>