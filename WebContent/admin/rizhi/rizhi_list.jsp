...
<html>
	...
	<body>
		<div class="page-content">
			<form action="<%=path%>/rizhi_list.action" class="form-inline"
				method="post">
				<div class="panel panel-default">
					...
					<pg:pager url="rizhi_list.action" items="${itemSize}"
...
$(document).ready(function(){
   $("#addBtn").click(function(){
        window.location.href = '<%=path%>/rizhi_toAdd.action';
   });
});
function delInfo(id){
	 if(confirm("是否确认删除？")){
	 window.location.href = '<%=path%>/rizhi_delete.action?id=' + id;
    }
}
</script>