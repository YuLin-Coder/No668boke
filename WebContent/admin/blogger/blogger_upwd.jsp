	...
	<div class="page-content">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<%=path%>/blogger_upwd.action" method="post" id="addForm">
					...
					<div class="container-fluid">
							...
							<div class="col-sm-8">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="uname" name="uname" readonly="readonly" size="35" class="form-control" type="text" value="${sessionScope.user.username}" tip="请输入用户名" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-4" style="margin-left: 20px;">
								<button type="submit" class="btn btn-primary" style="margin-top: 40px;">保存</button>
		...
		$("#addForm").validate({
			...
			rules : {
				pwd : {
					required : true,
					remote: {
	                    url: "<%=path%>/blogger_upwdVal.action",
	                    type: "post",
	                    dataType: "json",
	                    data: {
	                        pwd: function() {
