...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src="/boke/images/dialogclose.gif"  />';
   ...
   mainBox+='<tr style="height:'+this.config.height+'px" valign="top"><td id="dialogBody" style="position:relative;background-color:#e8e8e8"></td></tr></table></div>'+'<div id="dialogBoxShadow" style="display:none;z-index:'+baseZIndex+';"></div>';
